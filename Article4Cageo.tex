...
\begin{figure}
  \centering
  \subfigure[WLR model]{
  \includegraphics[width=4.6cm]{Definitions/Fig_Weight_LR.png}
  }
  \quad
  \subfigure[WLightGBM model]{
  \includegraphics[width=4.6cm]{Definitions/Fig_Weight_LGBM.png}
  }
  \quad
  \subfigure[WRF model]{
  \includegraphics[width=4.6cm]{Definitions/Fig_Weight_RF.png}
  }
